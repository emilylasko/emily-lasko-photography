      ...
      <div className="w-full bg-white shadow-sm">
        <header className="w-full py-2 px-4 md:px-8">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
            ...
            <nav className={`${isMenuOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row items-center gap-4 text-[#231f20] font-medium text-sm font-[var(--font-pt-sans)] uppercase tracking-wide w-full md:w-auto bg-white md:bg-transparent absolute md:relative top-[80px] md:top-0 left-0 p-4 md:p-0 shadow-lg md:shadow-none`}>
